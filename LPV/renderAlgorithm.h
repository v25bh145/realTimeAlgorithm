...
public:
	RenderAlgorithm() {
		...
		LightInjectionPass* lightInjectionPass = new LightInjectionPass(1, 100);
		LightPropogationPass* lightPropogationPass = new LightPropogationPass(2, lightInjectionPass->getIGridTextureSize());
